...
var priority_queue = load("priority_queue.gd")
...
func FindPath(start, end, characterWidth, characterHeight, maxCharacterJumpHeight, mSearchLimit = 2000):
